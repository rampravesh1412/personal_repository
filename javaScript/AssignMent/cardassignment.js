let objData = [
  ...
  },
  {
    ...
    imdbRating: 7.6,
    posterurl:
      "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRbfgE6CHjD7ae6JNvKUft4RB8D4lKQWOk2Pw&usqp=CAU",
  },
  {
    title: "Socha Na Tha",
    year: "2005",
  ...
  },
  {
    ...
    imdbRating: 7.8,
    posterurl:
      "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcT0V5VFkDAW9DGLqQN0NWpVXVsZZnO7_g8ckg&usqp=CAU",
  },
  {
    title: "Devdas",
    year: "2002",
...
for (let i = 0; i < objData.length; i++) {
  ...
  let allData = objData[i];

  document.querySelector(".parentcard").innerHTML += `
 <div class="col">
 <div class="card h-100">
 <img src="${allData["posterurl"]}" class="card-img-top" alt="...">
 <div id="addImg" class="card-body">
 <h3 class="card-title">${allData["year"]}</h3>
 <h4 class="card-title">${allData["title"]}</h4>
  <p  style="white-space: nowrap; 
  width: 400px; 
  overflow: hidden;
  text-overflow: ellipsis;" class="card-text">${allData["storyline"]}</p>



  <button type="button" class="btn btn-outline-danger" data-bs-toggle="modal" data-bs-target="#staticBackdrop" id="btn" 
  onclick='onMovieFun(objData[${i}])'>More Content!</button>
...
let onMovieFun = (movieData) => {
  // console.log(movieData.title)
  console.log(movieData.title)
  document.querySelector('#movieImg')["src"] = movieData["posterurl"]
  document.getElementById('titlebdy').innerHTML = movieData.title;
  document.getElementById('yearsbdy').innerHTML = movieData.year;
  document.getElementById('actors').innerHTML = movieData.actors;
  document.getElementById('generls').innerHTML = movieData.genres;
